...
export const MARTINGALE_CONFIG = {
  ...
  // 代币地址（BSC链）
  tokenAddress: '0xd762f672b7fef590017e5e9430c844ab16d44444',
  ...
  // 注意：onchain 模式會自動搜尋 V2 和 V3 池子，支援所有常見交易對
  priceSource: 'onchain',

  // 自定義流動性池地址（可選，用於 onchain 模式）
  // 如果不提供，系統會自動搜尋：
  // - V2: WBNB, USDT, USDC, BUSD, USD1 池
  // - V3: 上述代幣的所有 fee tiers (0.01%, 0.05%, 0.25%, 1%)
  // 自動搜尋通常就夠用了，除非你需要指定特定池子
  customPoolAddress: null,  // 設為 null 啟用自動搜尋
  ...
  // 最大止盈次數（達到後關閉策略，0 = 無限制）
  maxTakeProfitCount: 20,
  ...
  // 价格检查间隔（毫秒）
  priceCheckInterval: 1500, // 1秒检查一次
